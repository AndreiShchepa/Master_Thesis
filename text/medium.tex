...
% Contents of the attachment
    ...
    \dirtree{%
        ...
        .3 alembic/\DTcomment{database migration scripts (Alembic)}.
        % .3 data/\DTcomment{evaluation datasets and golden findings}.
        % .3 scripts/\DTcomment{helper scripts (seeding, full evaluation)}.
        ...
        % .4 reporting/\DTcomment{result export utilities}.
